...
export interface TimeObj { 
  ...
  tod: ChangeEvent<HTMLSelectElement> | 'AM' | 'PM';
}
...
export interface DisarmRecordsObj2 {
  alarm1?: string | undefined;
  alarm2?: string | undefined;
...
export interface GetDisarmRecordsDataParams {
  ...
  setDisarmRecords: (arg0: DisarmRecordsData | ((arg0: DisarmRecordsData) => DisarmRecordsData)) => void;
};
